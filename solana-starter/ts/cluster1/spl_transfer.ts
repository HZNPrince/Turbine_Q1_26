...
import wallet from "../../TurHCThfhhm41FptMhG7C8daUBLaEjVQJnMZTybj9yi.json"
...
;(async () => {
  try {
    ...
    const transfer_sig = await transfer(connection, keypair, from_ata.address, to_ata.address, keypair, 100_000000)
